...
export default function StudySlider() {
  ...
  return <>
    <div className="study-layout">
      <div className="study-media"><img className="study-cover" src="/assets/images/study-bonuses-mockup-v2.webp" alt="Материалы, модули и бонусы обучения AI‑креаторов" loading="lazy" decoding="async" /></div>
