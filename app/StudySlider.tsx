...
export default function StudySlider() {
  ...
  return <>
    <div className="study-layout">
      <div className="study-media"><video className="study-cover" src="/assets/videos/study-overview-video-v1.mp4" autoPlay muted loop playsInline preload="metadata" aria-label="Пример AI-видео, созданного во время обучения" /></div>
