...
const results = [
  { title: 'СОЗДАДИТЕ AI-ФОТОСЕССИИ', text: 'Научитесь создавать реалистичные изображения для одежды, косметики, экспертов и других коммерческих ниш.', emphasis: 'реалистичные изображения', image: '01-ai-photoshoots.webp' },
